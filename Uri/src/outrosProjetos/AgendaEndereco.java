...
import outrosProjetos.Contato;

public class AgendaEndereco {          // varios contatos(quantidade, lista)
	private int maxContatos;           
	private int contContatos;          // apaga pesquisa e cadastra
	private Contato [] contatos;        // banco de dados      
